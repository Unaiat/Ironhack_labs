...
class War:
    ...
    def vikingAttack(self):
        ...
        saxon_warrior = random.choice(self.saxonArmy)    
        saxon_damage = saxon_warrior.receiveDamage(viking_warrior.attack())
    ...
    def saxonAttack(self):
        viking_warrior = random.choice(self.vikingArmy)
        saxon_warrior = random.choice(self.saxonArmy)
        viking_damage = viking_warrior.receiveDamage(saxon_warrior.attack())
